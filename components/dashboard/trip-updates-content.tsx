...
import { 
  ...
  CheckCircle2, Clock, Plane, Hotel, Mountain
} from "lucide-react"

export function TripUpdatesContent() {
    ...
    <div className="flex-1 flex flex-col bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 px-8 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Trip Updates</h1>
            <p className="text-sm text-gray-500 mt-1">Updated 5 seconds ago</p>
          </div>
          ...
          <Card className="overflow-hidden border-gray-200 hover:shadow-lg transition-all duration-300">
            <div className="relative h-48 bg-gradient-to-br from-slate-700 to-slate-800">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <p className="text-white/60 text-lg">Munnar Tea Gardens & Hills</p>
              </div>
            </div>
            ...
            <div className="p-6">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h4 className="text-xl font-bold text-gray-900 mb-1">Munnar Escape</h4>
                  <p className="text-sm text-gray-500">Jan 15 - Jan 19, 2025 • 4 nights</p>
                  <div className="flex items-center gap-2 mt-2">
                    <span className="text-sm font-medium text-gray-700">Trip ID</span>
                    <span className="text-sm text-gray-500">#TRV-2847</span>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-sm text-gray-500 mb-1">Trip Progress</p>
                  <p className="text-lg font-bold text-gray-900">Day 2 of 4</p>
                </div>
              </div>
                  ...
                  <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-1">
                        <p className="text-sm font-medium text-gray-900">Tea Valley Resort</p>
                        <Button variant="link" size="sm" className="h-auto p-0 text-xs">View</Button>
                      </div>
                      <p className="text-xs text-gray-500">Check-in: 2:00 PM today • Digital key available</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <Button variant="link" size="sm" className="h-auto p-0 text-xs">Track</Button>
                      </div>
                      <p className="text-xs text-gray-500">Driver: Ravi Kumar • +91 98765 43210</p>
                    </div>
                  </div>
                </div>
              </div>
